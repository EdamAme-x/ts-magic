...
export type ToNumber<A extends UInt8> = Unwrap<A> extends infer B extends UInt8Bits ? ToUnsignedBits<B> : never;
...
type FromPositive<N extends number> = ExtractBit<N, 128> extends {
	bit: infer B7 extends Bit;
	rest: infer R7 extends number;
}
	? ExtractBit<R7, 64> extends { bit: infer B6 extends Bit; rest: infer R6 extends number }
...
export type FromNumber<N extends number> = FromPositive<N>;
...
type _RoundTrip255 = Expect<IsEqual<ToNumber<FromNumber<255>>, 255>>;
type _RoundTrip128 = Expect<IsEqual<ToNumber<FromNumber<128>>, 128>>;
